  ...
  return (
    ...
    <div className="contact-container">
      <div className="social-links">
        ...
        <Link to="https://www.facebook.com/kisansarathi"><img src={logo1}  style={{height:"auto",width:"120px"}} /></Link>
        <Link to=""><img src={logo5} style={{height:"auto",width:"70px"}}/></Link>
        <Link to="https://www.youtube.com/"><img src={logo3} style={{height:"auto",width:"80px"}}/></Link>
        <Link to="#"><img src={logo2} style={{height:"auto",width:"80px"}}/></Link>        
        <Link to="#"><img src={logo4} style={{height:"auto",width:"100px", borderRadius:"10px"}}/></Link>
